...
const routes = [
  ...
  { path: '/mahasiswa/formPengajuan', name: 'formPengajuan', element: wrapComponent(FormPengajuan, false) },
  { path: '/admin/dataDosen', name: 'TabelDosen', element: wrapComponent(CrudDosen, false) },
  { path: '/admin/detailDosen/:key', name: 'DetailDosen', element: wrapComponent(DetailDosen, false) },
  { path: '/admin/tambahDosen', name: 'TambahDosen', element: wrapComponent(TambahDosen, false) },
  { path: '/admin/TabelImport', name: 'TabelImport', element: wrapComponent(TabelImport, false) },
  // { path: '/admin/TabelEkspor', name: 'TabelEkspor', element: wrapComponent(TabelEkspor, false) },
  // { path: '/admin/ImporTabel', name: 'ImporTabel', element: wrapComponent(ImporTabel, false) },
  // { path: '/admin/EksporTabel', name: 'EksporTabel', element: wrapComponent(EksporTabel, false) },
  { path: '/admin/rekap', name: 'RekapPengajuan', element: wrapComponent(RekapPengajuan, false) },
  { path: '/admin/rekap/detail/:id', name: 'RekapPengajuanDetail', element: wrapComponent(RekapPengajuanDetail, false) },
  { path: '/admin/editDosen/:key', name: 'EditDosen', element: wrapComponent(EditDosen, false) },
  { path: '/admin/dataJadwal', name: 'TabelJadwal', element: wrapComponent(CrudJadwal, false) },
  { path: '/admin/tambahJadwal', name: 'TambahJadwal', element: wrapComponent(TambahJadwal, false) },
  { path: '/admin/editJadwal/:key', name: 'EditJadwal', element: wrapComponent(EditJadwal, false) },
  { path: '/admin/detailJadwal/:key', name: 'DetailJadwal', element: wrapComponent(DetailJadwal, false) },
  { path: '/admin/dataMahasiswa/', name: 'TabelMahasiswa', element: wrapComponent(TabelMahasiswa, false) },
  { path: '/admin/mahasiswa/edit/:id', name: 'EditMahasiswa', element: wrapComponent(EditMahasiswa, false) },
  { path: '/admin/mahasiswa/detail/:id', name: 'DetailMahasiswa', element: wrapComponent(DetailMahasiswa, false) },
  { path: '/admin/mahasiswa/tambah', name: 'TambahMahasiswa', element: wrapComponent(TambahMahasiswa, false) },
  { path: '/dosen/verifyPengajuan/:key', name: 'VerifyPengajuan', element: wrapComponent(VerifyPengajuan, false) },
  { path: '/dosen/tabelPengajuan', name: 'TabelPengajuan', element: wrapComponent(TabelPengajuan, false) },
  { path: '/dosen/dashboard', name: 'DashboardDosen', element: wrapComponent(DashboardDosen, false) },
  { path: '/mahasiswa/dashboard', name: 'DashboardMahasiswa', element: wrapComponent(DashboardMahasiswa, false) },
  { path: '/mahasiswa/historyPengajuan', name: 'HistoryPengajuanMahasiswa', element: wrapComponent(HistoryPengajuanMahasiswa, false) },
  { path: '/mahasiswa/Pengajuan/detail/:key', name: 'DetailPengajuanMahasiswa', element: wrapComponent(DetailPengajuanMahasiswa, false) },
  { path: '/mahasiswa/Pengajuan', name: 'TabelPengajuanMahasiswa', element: wrapComponent(TabelPengajuanMahasiswa, false) },
  { path: '/mahasiswa/Pengajuan/edit/:key', name: 'UpdatePengajuanMahasiswa', element: wrapComponent(UpdatePengajuanMahasiswa, false) },
  { path: '/admin/dataKelas', name: 'CrudKelas', element: wrapComponent(CrudKelas, false) },
  { path: '/admin/tambahKelas', name: 'TambahKelas', element: wrapComponent(TambahKelas, false) },
  { path: '/admin/editKelas/:key', name: 'EditKelas', element: wrapComponent(EditKelas, false) },
  { path: '/admin/detailKelas/:key', name: 'DetailKelas', element: wrapComponent(DetailKelas, false) },
  { path: '/admin/dashboard', name: 'DashboardAdmin', element: wrapComponent(DashboardAdmin, false) },
  { path: '/dosen/dashboard/daftarMahasiswa', name: 'DaftarMahasiswa', element: wrapComponent(DaftarMahasiswa, false) },
  { path: '/mahasiswa/profile', name: 'ProfileMahasiswa', element: wrapComponent(ProfileMahasiswa, false) },
  { path: '/mahasiswa/profile/edit', name: 'EditProfileMahasiswa', element: wrapComponent(EditProfileMahasiswa, false) }

  // Untuk route yang di-proteksi, berikut definisinya:
  // { path: '/dosen/tabelPengajuan', name: 'TabelPengajuan', element: wrapComponent(TabelPengajuan, false, {token: authToken}) },
]
