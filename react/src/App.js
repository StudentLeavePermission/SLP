      ...
      <HashRouter>
        <Suspense fallback={loading}>
          <Routes>
            ...
            <Route exact path="/tu/mahasiswa/" name="TabelMahasiswa" element={<TabelMahasiswa />} />
            <Route exact path="/tu/mahasiswa/detail/:id" name="DetailMahasiswa" element={<DetailMahasiswa />} />
